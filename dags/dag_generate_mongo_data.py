...
from module.mongo_utils import get_max_id, list_collections, create_collections, insert_data_to_mongodb
...
def generate_mongo_data() -> None: 
    ...
    for k in data:
        if k not in collections:
            create_collections(db_name, k)

    insert_data_to_mongodb(data, db_name)

    print('Data inserted')


dag = DAG('dag_generate_mongo_data',
    schedule_interval=timedelta(days=1),
    start_date=datetime(2025, 3, 16))


task_generate_mongo_data = PythonOperator( 
